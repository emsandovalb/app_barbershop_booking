          ...
          title: Column(
            ...
            children: [
              Builder(builder: (context) {
                ...
                return Text('Hello, $name', style: const TextStyle(fontSize: 14, color: Colors.white70));
              }),
              const SizedBox(height: 2),
              const Text('Good morning 🌞', style: TextStyle(fontSize: 24, fontWeight: FontWeight.w800, color: Colors.white)),
            ],
          ),
          actions: [
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    const Text('Categories', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700, color: Colors.white)),
                    Text('View all', style: TextStyle(color: Colors.white.withOpacity(.8)))
                  ],
                ),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    const Text('Popular ground', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700, color: Colors.white)),
                    InkWell(
                      onTap: () => Navigator.of(context).pushNamed(AppRoutes.categories),
                      child: Text('View all', style: TextStyle(color: Colors.white.withOpacity(.8))),
                    )
                  ],
                ),
                const SizedBox(height: 12),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    const Text('Nearby you', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700, color: Colors.white)),
                    Text('View all', style: TextStyle(color: Colors.white.withOpacity(.8)))
                  ],
                ),
                const SizedBox(height: 12),
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: const [
                          Icon(Icons.place, size: 14, color: Colors.white),
                          SizedBox(width: 4),
                          Text('1.2 km', style: TextStyle(color: Colors.white)),
                        ],
                      ),
                    ),
                  )
